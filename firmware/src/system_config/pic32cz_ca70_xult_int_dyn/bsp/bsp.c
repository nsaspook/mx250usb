...
{
    return ( SYS_PORTS_PinRead(PORTS_ID_0, switch_port_channel_map[bspSwitch], switch_port_bit_pos_map[bspSwitch]) );
}
...
void BSP_LEDStateSet(BSP_LED led, BSP_LED_STATE state)
{
    ...
    {
        SYS_PORTS_PinWrite (PORTS_ID_0 , led_port_channel_map[led], led_port_bit_pos_map[led], state );
    }
    else
    {
        SYS_PORTS_PinWrite (PORTS_ID_0 , led_port_channel_map[led], led_port_bit_pos_map[led], !state );
...
void BSP_LEDToggle(BSP_LED led)
{
    SYS_PORTS_PinToggle(PORTS_ID_0, led_port_channel_map[led], led_port_bit_pos_map[led] );
}
...
BSP_LED_STATE BSP_LEDStateGet (BSP_LED led)
{
    ...
    /* Get LED Status */
    value = SYS_PORTS_PinLatchedGet(PORTS_ID_0, led_port_channel_map[led], led_port_bit_pos_map[led]);
...
void BSP_LEDOn(BSP_LED led)
{
    if(led_active_level_map[led] == BSP_LED_ACTIVE_HIGH)
    {
        SYS_PORTS_PinSet( PORTS_ID_0, led_port_channel_map[led], led_port_bit_pos_map[led] );
    }
    else
    {
        SYS_PORTS_PinClear( PORTS_ID_0, led_port_channel_map[led], led_port_bit_pos_map[led] );
    }
}
